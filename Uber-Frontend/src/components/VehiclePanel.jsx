...
const VehiclePanel = (props) => {
    return (
        <div>
            <h5 onClick={()=>{props.setVehiclePanelOpen(false)}} className="p-1 text-center absolute top-0  w-[93%]" ><i className="text-gray-300 text-3xl ri-arrow-down-wide-line"></i></h5>
          <div>
            ...
            <div onClick={()=>{
                ...
                <h2 className='text-lg font-semibold'>₹{"192.16"}</h2>
            </div>
            <div onClick={()=>{
                props.setConfirmRidePanel(true)
            }}  className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3  items-center justify-between'>
